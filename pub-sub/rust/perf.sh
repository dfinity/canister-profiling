...
output(file, stringify("|Rust|[caller (", __cost__, ")](rs_subscribe.svg) / [callee (", callee_cost, ")](rs_pub_register.svg)|"));
...
output(file, stringify("[caller (", __cost__, ")](rs_publish.svg) / [callee (", callee_cost, ")](rs_sub_update.svg)|\n"));
